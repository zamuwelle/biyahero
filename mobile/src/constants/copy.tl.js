...
export const startTrip = {
	...
	viaLabel: 'RUTA MO',
	viaHint: 'Kung may sariling ruta ka, iguhit mo ito sa mapa. Para makita ka ng mga pasaherong naghihintay sa mga kalsadang dinadaanan mo.',
	viaPinned: 'Itinurong kalsada',
	viaRemove: 'Alisin ang puntong ito',
	drawOpen: 'Iguhit ang ruta mo',
	drawEdit: 'Baguhin ang ruta',
	drawHint: 'Sunod-sunod na i-tap ang mga kalsadang dinadaanan mo, mula dito hanggang sa punta mo.',
