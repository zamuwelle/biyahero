...
export const startTrip = {
	...
	viaLabel: 'YOUR ROUTE',
	viaHint: 'If your route is your own, trace it on the map — so commuters waiting on the roads you drive can see you.',
	viaPinned: 'Pinned road',
	viaRemove: 'Remove this point',
	drawOpen: 'Trace your route',
	drawEdit: 'Change the route',
	drawHint: 'Tap the roads you drive through, in order, from here to where you are going.',
